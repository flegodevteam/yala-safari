    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-indigo-800 text-white transition-all duration-300`}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <button className="flex items-center w-full p-2 rounded-lg hover:bg-indigo-700">
...
const NavItem = ({ icon, text, active, onClick, sidebarOpen }) => {
  return (
    <button
      onClick={onClick}
      className={`flex items-center w-full p-3 ${active ? 'bg-indigo-700' : 'hover:bg-indigo-700'}`}
    >
