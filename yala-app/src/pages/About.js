    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold sm:text-5xl sm:tracking-tight lg:text-6xl" style={{ color: '#034123' }}>
            About Yala Safari
          </h1>
          <p className="mt-5 max-w-xl mx-auto text-xl" style={{ color: '#333333' }}>
            Our story, mission, and commitment to responsible tourism.
          </p>
        </div>
  
        <div className="bg-white shadow-lg overflow-hidden rounded-lg border transition-shadow duration-300 hover:shadow-xl" style={{ borderColor: 'rgba(3, 65, 35, 0.1)' }}>
          <div className="px-4 py-5 sm:p-6">
            <div className="md:flex md:items-center md:justify-between">
              <div className="md:w-1/2">
                <h2 className="text-2xl font-bold" style={{ color: '#034123' }}>Our Story</h2>
                <div className="mt-4 space-y-4" style={{ color: '#333333' }}>
                  <p>
        ...
        <div className="mt-12 bg-white shadow-lg overflow-hidden rounded-lg border transition-shadow duration-300 hover:shadow-xl" style={{ borderColor: 'rgba(3, 65, 35, 0.1)' }}>
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-2xl font-bold" style={{ color: '#034123' }}>Our Mission</h2>
              ...
              {[
                {
                  ...
                  icon: (
                    <svg className="h-8 w-8" style={{ color: '#f26b21' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 bg-white shadow-lg overflow-hidden rounded-lg border transition-shadow duration-300 hover:shadow-xl" style={{ borderColor: 'rgba(3, 65, 35, 0.1)' }}>
          <div className="px-4 py-5 sm:p-6">
            <h2 className="text-2xl font-bold" style={{ color: '#034123' }}>Our Team</h2>
            ...
            <div className="mt-8 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="pt-6">
                  <div className="flow-root bg-white rounded-lg px-6 pb-8 h-full border transition-transform duration-300 hover:scale-105 hover:shadow-lg" style={{ borderColor: 'rgba(3, 65, 35, 0.1)', backgroundColor: '#e6e6e6' }}>
                    <div className="-mt-6">
                      <div className="flex justify-center">
                        <div className="relative">
                          <img
                            className="h-24 w-24 rounded-full object-cover border-4"
                            style={{ borderColor: '#fee000' }}
                            src={member.image}
                            alt={member.name}
                          />
                          <span className="absolute bottom-0 right-0 text-white text-xs font-medium px-2 py-1 rounded-full shadow-lg" style={{ backgroundColor: '#f26b21' }}>
                            {member.experience}
                          </span>
                        </div>
                      </div>
                      <h3 className="mt-6 text-lg font-medium text-center" style={{ color: '#034123' }}>{member.name}</h3>
                      <p className="mt-1 text-sm text-center" style={{ color: '#f26b21' }}>{member.role}</p>
                      <p className="mt-4 text-base text-center" style={{ color: '#333333' }}>{member.bio}</p>
                    </div>
                  </div>
                </div>
              ))}
