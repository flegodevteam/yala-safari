...
const MediaGallery = () => {
    const [images, setImages] = useState([
      ...
      { id: 2, url: 'https://example.com/image2.jpg', title: 'Elephant herd', category: 'wildlife', featured: false },
      { id: 3, url: 'https://example.com/image3.jpg', title: 'Safari jeep', category: 'equipment', featured: false },
    ]);
    
    const [categories, setCategories] = useState(['wildlife', 'landscape', 'equipment', 'people']);
