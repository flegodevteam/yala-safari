      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg mb-4">
            Booking ID: <span className="font-mono font-bold text-yellow-600">{confirmedBookingId}</span>
          </p>
        </div>
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-lg p-4 border border-yellow-300">
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>• You will receive a <strong>confirmation email</strong> at <span className="font-semibold text-green-600">{bookingData.customerEmail}</span></li>
                  <li>• Once approved, we'll send payment instructions</li>
                  <li>• Keep your Booking ID for reference: <span className="font-mono font-bold">{confirmedBookingId}</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
          <h3 className="font-bold text-blue-900 mb-3">📱 Track Your Booking Status</h3>
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="flex-1 bg-white border-2 border-green-600 text-green-600 hover:bg-green-50 font-semibold py-3 rounded-lg transition-colors"
          >
            🖨️ Print Details
          </button>
        </div>
