    ...
    <footer className="relative bg-[#333333] text-white overflow-hidden" role="contentinfo">
      ...
      <div className="relative max-w-7xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 pb-8 border-b border-white/20">
          ...
          <a href="https://www.facebook.com/share/1EDyLRKpvB" target="_blank" className="text-[#ffffff] hover:text-[#f26b21] transition-colors duration-300" aria-label="Facebook">
                <FaFacebook size={24} />
              </a>
              <a href="/" target="_blank" className="text-[#ffffff] hover:text-[#f26b21] transition-colors duration-300" aria-label="Instagram">
                <FaInstagram size={24} />
              </a>
              <a href="/" target="_blank" className="text-[#ffffff] hover:text-[#f26b21] transition-colors duration-300" aria-label="Twitter">
                <FaTwitter size={24} />
              </a>
              <a href="https://www.tripadvisor.com/Attraction_Review-g1102395-d9975853-Reviews-Yala_Safari_With_Tharindu_Gihan-Tissamaharama_Southern_Province.html" target="_blank" className="text-[#ffffff] hover:text-[#f26b21] transition-colors duration-300" aria-label="TripAdvisor">
